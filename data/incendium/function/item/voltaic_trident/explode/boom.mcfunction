...
execute facing entity @e[type=#incendium:mobs,distance=..10,limit=12,sort=nearest] eyes if predicate incendium:random/99 run function incendium:item/voltaic_trident/explode/lightning/start_ray
