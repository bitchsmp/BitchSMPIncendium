...
execute at @e[type=marker,tag=in.altar,distance=..4] run summon blaze ~ ~4 ~ {attributes: [{base: 1000.0d, id: "minecraft:max_health"}, {base: 20.0d, id: "minecraft:armor"}, {base: 0.87d, id: "minecraft:knockback_resistance"}, {base: 20.0d, id: "minecraft:attack_knockback"}, {base: 12.0d, id: "minecraft:armor_toughness"}, {base: 0.4d, id: "minecraft:movement_speed"}, {base: 20.0d, id: "minecraft:attack_damage"}, {base: 70.0d, id: "minecraft:follow_range"}], PersistenceRequired: 1b, Tags: ["in.hovering_inferno"], Health: 1000.0f, Rotation: [-129.48582f, 0.0f], equipment: {mainhand:{id:"totem_of_undying",count:1b}}, CustomName: {translate:"incendium.admin.menu.inferno",fallback:"Hovering Inferno", "color": "#ff6600"}, CanPickUpLoot: 0b, DeathLootTable:"incendium:hovering_inferno"}
...
bossbar set incendium:inferno value 1000
bossbar set incendium:inferno max 1000
