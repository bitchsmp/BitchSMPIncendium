...
summon minecraft:fireball ~1 ~1 ~ {Motion:[1.0,-0.2,0.0],ExplosionPower:2}
summon minecraft:fireball ~-1 ~1 ~ {Motion:[-1.0,-0.2,0.0],ExplosionPower:2}
summon minecraft:fireball ~ ~1 ~1 {Motion:[0.0,-0.2,1.0],ExplosionPower:2}
summon minecraft:fireball ~ ~1 ~-1 {Motion:[0.0,-0.2,-1.0],ExplosionPower:2}
summon minecraft:fireball ~1 ~1 ~1 {Motion:[0.71,-0.2,0.71],ExplosionPower:2}
summon minecraft:fireball ~-1 ~1 ~1 {Motion:[-0.71,-0.2,0.71],ExplosionPower:2}
summon minecraft:fireball ~1 ~1 ~-1 {Motion:[0.71,-0.2,-0.71],ExplosionPower:2}
summon minecraft:fireball ~-1 ~1 ~-1 {Motion:[-0.71,-0.2,-0.71],ExplosionPower:2}
